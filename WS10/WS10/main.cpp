...
int main() {
    ...
    std::cout << "Searching for Tesla cars: " << endl;
    ...
    if (search(Cres, C, 7, "Tesla")) {
        std::cout << Cres.size() << " match" << (Cres.size() == 1 ? "" : "es") << " found:" << endl;
        for (int i = 0; i < Cres.size(); i++) {
            std::cout << (i + 1) << ": " << Cres[i] << endl;
        }
    }
    else {
    ...
    std::cout << "Searching for students with 4.0 Gpa:" << endl;
    ...
    if (search(Sres, S, 6, 4.0)) {
        std::cout << Sres.size() << " match" << (Sres.size() == 1 ? "" : "es") << " found:" << endl;
        for (int i = 0; i < Sres.size(); i++) {
            std::cout << (i + 1) << ": " << Sres[i] << endl;
        }
    }
    else {
        std::cout << "No matches found!" << endl;
    ...
    std::cout << "Searching for employees who share office number 111:" << endl;
    ...
    if (search(Eres, E, 6, 111)) {
        std::cout << Eres.size() << " match" << (Eres.size() == 1 ? "" : "es") << " found:" << endl;
        for (int i = 0; i < Eres.size(); i++) {
            std::cout << (i + 1) << ": " << Eres[i] << endl;
        }
    }
    else {
        std::cout << "No matches found!" << endl;
    ...
    std::cout << "Searching for employees who share office number 555:" << endl;
    // Call the search function to search the array E 
